...
SYM_KERNEL( sse_avx_fma_partial_aligned,  HAS_SSE | HAS_AVX | HAS_FMA, 4 * sizeof(float), 4 * sizeof(float) );
...
SYM_KERNEL( sse_avx_fma_partial_aligned_opt, HAS_SSE | HAS_AVX | HAS_FMA, 4 * sizeof(float), 4 * sizeof(float) );
