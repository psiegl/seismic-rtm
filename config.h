...
enum _kernel_t {
  ...
  KERNEL__SIMD_SSE_FMA_STD,
  KERNEL__SIMD_SSE_UNALIGNED,
  KERNEL__SIMD_SSE_FMA_UNALIGNED,
  KERNEL__SIMD_SSE_ALIGNED,
  KERNEL__SIMD_SSE_FMA_ALIGNED,
  KERNEL__SIMD_SSE_PARTIAL_ALIGNED,
  KERNEL__SIMD_SSE_FMA_PARTIAL_ALIGNED,
  KERNEL__SIMD_SSE_ALIGNED_NOT_GROUPED,
  KERNEL__SIMD_SSE_FMA_ALIGNED_NOT_GROUPED,
  KERNEL__SIMD_AVX_UNALIGNED,
  KERNEL__SIMD_AVX_FMA_UNALIGNED,
  KERNEL__SIMD_AVX2_UNALIGNED,
  KERNEL__SIMD_AVX2_FMA_UNALIGNED
};
