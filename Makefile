...
SSE    := kernel_sse_unaligned.o kernel_sse_fma_unaligned.o kernel_sse_aligned_not_grouped.o kernel_sse_fma_aligned_not_grouped.o kernel_sse_aligned.o kernel_sse_fma_aligned.o kernel_sse_std.o kernel_sse_fma_std.o kernel_sse_partial_aligned.o
...
FMA    := kernel_sse_fma_unaligned.o kernel_sse_fma_aligned_not_grouped.o kernel_sse_fma_aligned.o kernel_avx_fma_unaligned.o kernel_sse_fma_std.o kernel_avx2_fma_unaligned.o
